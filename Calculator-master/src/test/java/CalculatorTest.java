...
public class CalculatorTest {
    ...
    @Test
    @DisplayName("#divide > When the result is a non integer return is the integer part of the number")
    void divideWhenTheResultIsANonIntegerReturnIsTheIntegerPartOfTheNumber() {
